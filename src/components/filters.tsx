...
export function Filters() {
  ...
  return (
    <div className="w-full z-10 flex flex-col gap-3 text-slate-700 rounded-md bg-slate-100/10 backdrop-blur-sm dark:text-white p-5 shadow-md">
      ...
      <label className="cursor-pointer flex items-center justify-center text-sm font-bold bg-slate-800 text-white p-2 rounded w-full border border-pink-600">
        <Switch
        ...
        />
        ESCLUDI i tag selezionati invece di includerli
      </label>
